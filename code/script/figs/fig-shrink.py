...
class params:
    ...
    # --- Data inputs
    dist_ells = paths.data('gauss/summ_base_300L4_ell.csv')
    focl_ells = [
        paths.data('shrink/rfs_shrink_b0.1_ell.csv'),
        paths.data('shrink/rfs_shrink_b0.2_ell.csv'),
        paths.data('shrink/rfs_shrink_b0.3_ell.csv'),
        paths.data('shrink/rfs_shrink_b0.4_ell.csv'),
    ]
    comp_ells = [
    ...
    bhv_focl = {
        ('0.1', 'Gauss'): paths.data('cornet/bhv_gauss_n600_beta_1.1.h5'), # fig-cornet.md
        ('0.2', 'Gauss'): paths.data('cornet/bhv_gauss_n600_beta_2.0.h5'), # fig-cornet.md
        ('0.3', 'Gauss'): paths.data('cornet/bhv_gauss_n600_beta_4.0.h5'), # fig-cornet.md
        ('0.4', 'Gauss'): paths.data('cornet/bhv_gauss_n600_beta_11.0.h5'), # fig-cornet.md
        ('0.1', 'Shrink'): paths.data('shrink/bhv_shrink_beta_0.1.h5'),
        ('0.2', 'Shrink'): paths.data('shrink/bhv_shrink_beta_0.2.h5'),
        ('0.3', 'Shrink'): paths.data('shrink/bhv_shrink_beta_0.3.h5'),
        ('0.4', 'Shrink'): paths.data('shrink/bhv_shrink_beta_0.4.h5'),
    }
    sgain_focl = [
        paths.data('shrink/lenc_ms_n100_b0.1.h5.sgain.npz'),
        paths.data('shrink/lenc_ms_n100_b0.2.h5.sgain.npz'),
        paths.data('shrink/lenc_ms_n100_b0.3.h5.sgain.npz'),
        paths.data('shrink/lenc_ms_n100_b0.4.h5.sgain.npz'),
    ]
    sgain_comp = [
