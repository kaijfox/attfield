...
class params:
    ...
    output = 'plots/figures/fig4/fig-flat.pdf'
    cis_file = paths.data("ci_cmd.txt")
    
    # --- Data inputs
    # Receptive fields
    dist_ells = paths.data('runs/270420/summ_base_ell.csv') # fig-gauss.md
    focl_ells = [
        paths.data('flat/summ_stitch_b1.1_ell.csv'),
        paths.data('flat/summ_stitch_b2.0_ell.csv'),
        paths.data('flat/summ_stitch_b4.0_ell.csv'),
        paths.data('flat/summ_stitch_b11.0_ell.csv'),
    ]
    ...
    bhv_focl = {
        ...
        ('1.1', 'Flat'): paths.data('flat/bhv_stitch_beta_1.1.h5'),
        ('2.0', 'Flat'): paths.data('flat/bhv_stitch_beta_2.0.h5'),
        ('4.0', 'Flat'): paths.data('flat/bhv_stitch_beta_4.0.h5'),
        ('11.0', 'Flat'): paths.data('flat/bhv_stitch_beta_11.0.h5'),
    }
    # Effective gain
    sgain_focl = [
        paths.data('flat/enc_stitch_b1.1.h5.sgain.npz'),
        paths.data('flat/enc_stitch_b2.0.h5.sgain.npz'),
        paths.data('flat/enc_stitch_b4.0.h5.sgain.npz'),
        paths.data('flat/enc_stitch_b11.0.h5.sgain.npz'),
    ]
...
# ----------------  extra confidence intervals/statistics  ----
