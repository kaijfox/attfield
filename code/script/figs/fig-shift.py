...
class params:
    ...
    output = 'plots/figures/fig5/fig-shift.pdf'
    cis_file = paths.data('ci_cmd.txt')
    

    # --- Data inputs
    # Receptive fields
    dist_ells = paths.data('gauss/summ_base_ell.csv') # fig-gauss.md
    focl_ells = [
        paths.data('shift/summ_mim_gauss_b1.1_ell.csv'),
        paths.data('shift/summ_mim_gauss_b2.0_ell.csv'),
        paths.data('shift/summ_mim_gauss_b4.0_ell.csv'),
        paths.data('shift/summ_mim_gauss_b11.0_ell.csv'),
    ]
    # Receptive fields (gaussian comparison)
    comp_ells = [
        paths.data('gauss/summ_cts_gauss_b1.1_ell.csv'), # fig-gauss.md
        paths.data('gauss/summ_cts_gauss_b2.0_ell.csv'), # fig-gauss.md
        paths.data('gauss/summ_cts_gauss_b4.0_ell.csv'), # fig-gauss.md
        paths.data('gauss/summ_cts_gauss_b11.0_ell.csv'), # fig-gauss.md
    ]
    # Behavior
    bhv_dist = paths.data('cornet/bhv_base.h5') # fig-cornet.md
    bhv_focl = {
        ('1.1', 'Gauss'): paths.data('cornet/bhv_gauss_b1.1.h5'), # fig-cornet.md
        ('2.0', 'Gauss'): paths.data('cornet/bhv_gauss_b2.0.h5'), # fig-cornet.md
        ('4.0', 'Gauss'): paths.data('cornet/bhv_gauss_b4.0.h5'), # fig-cornet.md
        ('11.0', 'Gauss'): paths.data('cornet/bhv_gauss_b11.0.h5'), # fig-cornet.md
        ('1.1', 'Shift'): paths.data('shift/bhv_mim_gauss_beta_1.1.h5'),
        ('2.0', 'Shift'): paths.data('shift/bhv_mim_gauss_beta_2.0.h5'),
        ('4.0', 'Shift'): paths.data('shift/bhv_mim_gauss_beta_4.0.h5'),
        ('11.0', 'Shift'): paths.data('shift/bhv_mim_gauss_beta_11.0.h5'),
    }
    # Effectve gain
    sgain_focl = [
        paths.data('shift/lenc_mg_n100_b1.1.h5.sgain.npz'),
        paths.data('shift/lenc_mg_n100_b2.0.h5.sgain.npz'),
        paths.data('shift/lenc_mg_n100_b4.0.h5.sgain.npz'),
        paths.data('shift/lenc_mg_n100_b11.0.h5.sgain.npz'),
    ]
