...
Provider for images directly as generated by a DistilledDetectionTask
operating on the given HDF5 archive.

See neighboring `h5_images.py` for spec of an image provider.
