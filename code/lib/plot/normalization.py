"""
Plotting functions for nonlinear normalization data.

### Functions
- `locus_field_ratio` - Measure ratio of gains between locus of attention
    and unattended field.
- `normalization_data` - Load activation from `.norm.sgain.npz` files and
    compute locus-field ratios.
- `normalization_heatmap` - Read locus-field ratios from `normalization_data`'s
    output and plot to a heatmap on the given axis
"""
