"""
Plotting functions for receptive field model diagrams.

### Functions
- `rf_grad_data` - Open an HDF5 archive of reptive field gradient data.
- `plot_rf_heat` - Plot heatmap of receptive field gradient data.
- `plot_rf_ell` - Plot an ellipse summary model of a receptive field.
- `rf_ellipses` - Plot a set of receptive field gradients and ellipses.
"""
