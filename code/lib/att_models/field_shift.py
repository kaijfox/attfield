...
Implementation of the shift-only attention model, as used in `fig-shift`.
Rewires connections of the targeted Conv2D layer according to an interpolated
field of measured RF shifts as represented by a `LinearField`.

"""

from lib.experiment import network_manager as nm
from lib.experiment import spatial_fields as fld
