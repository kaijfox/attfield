"""
Definition of the gaussian receptive field model, passed to the `summarize_rfs`
script. Fits a gaussian bump to a map of (absolute) gradients of a unit's
activation w.r.t. input space.
"""
